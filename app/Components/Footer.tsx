...
const Footer = () => {
  return (
    <Container>
      ...
      >
        <hr className="my-6 border-t-[1px] md:border-t-2 dark:border-secondary2 border-primary2 duration-700" />

        <div className="w-full h-fit flex flex-wrap gap-6 md:gap-3 md:px-8">
          <div className="w-fit flex flex-col flex-1 flex-wrap gap-5 footer">
            <div className="w-fit h-fit flex gap-2">
              <div className="w-[4px] self-stretch bg-tertiary"></div>
              <h3 className="uppercase font-extrabold text-base dark:text-secondary text-primary duration-700">
            ...
            <div className="w-fit flex flex-col gap-3 pl-3">
              ...
              <div className="flex gap-2">
                <svg
                  className="w-4 aspect-square dark:fill-secondary fill-primary duration-700"
                  viewBox="0 0 18 18"
                ...
                <p className="font-normal md:text-sm dark:text-secondary text-primary duration-700">
                  081233764580
                </p>
              </div>
              ...
              <div className="w-full flex gap-2">
                <svg
                  className="w-4 aspect-auto dark:fill-secondary fill-primary duration-700"
                  viewBox="0 0 18 14"
                  xmlns="http://www.w3.org/2000/svg"
                >
        ...
        <p className="text-[11px] md:text-sm dark:text-secondary2 text-primary2 duration-700 mt-9 md:mt-12 mb-4 md:mb-0 mx-auto">
